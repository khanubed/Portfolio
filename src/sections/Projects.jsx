...
import chatify from '../assets/projectImages/login.png'
...
const Projects = () => {
  ...
  return (
    ...
    <section id='projects' className='z-20 mt-[-25px]  text-white bg-black w-full h-[210vh]  rounded-b-[4%] relative'>
        ...
        <div ref={parentRef} className='bg-black absolute  flex flex-col  items-center w-full top-16 h-[180vh]'>
          ...
          <motion.div
            ...
            className='h-[65vh] top-[16vh] bg-black z-30 sticky w-[75vw] mb-16 border-2  rounded-3xl'
              ...
              <div className="flex p-6 pb-0  items-end">
                <div className='flex h-15dvh justify-between px-7 w-full items-end '> {/*TOP*/}
                  <div className='flex gap-5 items-end  '>
                    <span className='republica text-3xl'>Weather App</span>
                    <span className='text-lg'>(⚠️ Filler project, not featured.)</span>
                  </div>
          ...
          style={{ scale: card2Scale , y: card2Y }}
           className='h-[65vh] top-[24vh] bg-black z-50 sticky w-[75vw] border-2 rounded-3xl'>
            <div className='h-full w-full'>
    ...
    <div className='h-[20%] w-[100%] bg-black'></div>
    </>
